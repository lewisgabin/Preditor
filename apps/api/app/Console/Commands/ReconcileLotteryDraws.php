...
final class ReconcileLotteryDraws extends Command
{
    use ExecutesLotteryDrawCommand;

    protected $signature = 'draws:reconcile
    ...
    protected $description = 'Queue a lottery draw reconciliation.';
    ...
    {
        return SyncTrigger::Reconciliation;
    }
}
